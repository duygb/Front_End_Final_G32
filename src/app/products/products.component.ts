...
import { Sorter } from './products-list/common-products/sorter';
...
export class ProductsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.myServerHttpService.getAllProducts().subscribe((data) => {
  ...
  addToFavorite(item:Products){
    this.myServerHttpService.addToFavorite(item);
